...
import com.pgd.recruitingplatformservice.services.implementations.CountriesServiceImp;
...
public class CountriesServiceTests {
    ...
    @InjectMocks
    private CountriesServiceImp countriesService;
    ...
    public void getCountriesTest() {
        ...
        Optional<StringResults> results = countriesService.getCountriesList();

        Assertions.assertTrue(results.isPresent());
        Assertions.assertEquals(3, results.get().getResults().size());
        Assertions.assertEquals("Colombia", results.get().getResults().get(0));
        Assertions.assertEquals("Costa Rica", results.get().getResults().get(1));
        Assertions.assertEquals("Mexico", results.get().getResults().get(2));

    }

    @Test
    public void getEmptyCountriesTest() {
